    ...
    <body>
        ...
        <div class="header">
            ...
            <div class="admin-panel">
                <button class="dropdown-btn">Admin Actions ⬇</button>
                <div class="dropdown-content">
                    <a href="ViewListCustomersController">View List Customers</a>
                </div>
            </div>
        </div>
            ...
            <c:forEach items="${l}" var="b">
                <c:if test="${b.quantity != 0}">
                    <div class="book-card">
                        ...
                        <h4><a href="bookDetailController?BookID=${b.bookID}">${b.bookName}</a></h4>
                        <div class="book-details">
                            <p>Price: ${b.price}$</p>
                            <p>In Stock: ${b.quantity}</p>
                            <p>Author: ${b.author}</p>
                            <p>Category: ${b.category}</p>
                            <p>${b.discribe}</p> <!-- Hiển thị toàn bộ mô tả -->
                        </div>
