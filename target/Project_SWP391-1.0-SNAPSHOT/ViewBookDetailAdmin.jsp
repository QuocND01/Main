<%-- 
    Document   : ViewBookDetailAdmin
    Created on : Feb 22, 2025, 4:30:37 PM
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="card-footer d-flex justify-content-between">
                        <a href="updateBookController?BookID=${detailBook.bookID}" class="btn btn-success">Update</a>
                        <a href="deleteBookController?BookID=${detailBook.bookID}" class="btn delete-btn">Delete</a>
                    </div>
